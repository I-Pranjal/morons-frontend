...
export default function AchievementsForm({ 
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Achievements & Recognition</h1>
        <p className="text-gray-600">Showcase your honors, awards, and professional certifications</p>
      </div>
