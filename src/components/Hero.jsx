        ...
        <div className="flex gap-4 items-center justify-between flex-col lg:flex-row">
          ...
          <div className="flex-1 space-y-4 pb-4">
            ...
            <div className="space-y-2">
              {/* Sign-in options from first code */}
              <div className="grid w-fit">
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  <Link to="/booking">
                    <button className="bg-[#FFCB47] text-[#1B1B1B] font-bold py-2 px-12 border border-black rounded-lg flex items-center hover:bg-[#e6b73e]">
                  ...
                  <HashLink smooth to="#booking-experience">
                    <button className="bg-white text-[#1B1B1B] font-bold py-2 px-12 border border-black rounded-lg flex items-center hover:bg-gray-50">
