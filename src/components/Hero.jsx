            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center sm:justify-start">
                ...
                <HashLink smooth to="#booking-experience" className="w-full sm:w-auto">
                  <button className="w-full sm:w-auto bg-white text-black font-bold py-3 px-8 border-2 border-gray-200 rounded-lg flex items-center justify-center hover:bg-gray-50 shadow-md hover:shadow-lg transition-all duration-200">
