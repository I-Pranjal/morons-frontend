...
const SignInWithLinkedIn = () => {
  ...
  return (
    ...
    <Button 
      ...
      className="w-full bg-blue-600 hover:bg-blue-700 text-white py-6 px-4 rounded-xl transition-all duration-200 flex items-center justify-center space-x-3 font-medium my-6"
    >
